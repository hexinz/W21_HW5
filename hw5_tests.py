...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        return c5.deal_card(), hw5_cards.Card
    ...
    def test_q6(self):
        ...
        '''
        c6_origin = hw5_cards.Deck()
        c6 = hw5_cards.Deck()
        c6.deal_card()
        self.assertEqual(len(c6.cards), len(c6_origin.cards)-1)
        return len(c6.cards), len(c6_origin.cards)-1
    ...
    def test_q7(self):
        ...
        '''
        c7_origin = hw5_cards.Deck()
        c7 = hw5_cards.Deck()
        card = c7.deal_card()
        after_deal = len(c7.cards)
        c7.replace_card(card=card)
        after_replace = len(c7.cards)
        self.assertEqual(after_deal+1, after_replace)
        return after_deal+1, after_replace, len(c7_origin.cards)
    ...
    def test_q8(self):
        ...
        '''
        c8_origin = hw5_cards.Deck()
        c8 = hw5_cards.Deck()
        card = c8.deal_card()
        c8.replace_card(card=card)
        c8.replace_card(card=card)
        self.assertEqual(len(c8.cards), len(c8_origin.cards))
        return len(c8.cards), len(c8_origin.cards)
